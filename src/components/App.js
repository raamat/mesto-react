  ...
  return (
    <>
      <div className="page__container">
        ...
        <PopupWithForm name="edit-avatar" title="Обновить аватар" buttonText="Сохранить" isOpen={isEditProfilePopupOpen}> 
        ...
        <PopupWithForm name="edit-profile" title="Редактировать профиль" buttonText="Сохранить" isOpen={isAddPlacePopupOpen}> 
        ...
        <PopupWithForm name="add-card" title="Новое место" buttonText="Создать" isOpen={isEditAvatarPopupOpen}> 
